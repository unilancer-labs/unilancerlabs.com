...
const StepCard = ({ 
  ...
  return (
    <div
      style={{ zIndex }}
      className={`relative bg-white/95 dark:bg-dark-light/95 backdrop-blur-sm p-6 md:p-12 flex flex-col items-start gap-4 md:gap-6 group transition-all duration-300 hover:bg-white dark:hover:bg-dark-light ${getBorderClasses()} ${className}`}
    >
      {/* Hover Gradient */}
